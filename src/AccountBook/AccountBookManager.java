...
public class AccountBookManager {
	...
	public void update(int id, AccountBook a) {
		if(a.getType().equals(""))a.setType(a.getType());
		if(a.getAmount()==0)a.setAmount(a.getAmount());
		if(a.getCategory().equals(""))a.setCategory(a.getCategory());
		if(a.getDate().equals(""))a.setDate(a.getDate());
		a.setId(id);
		dao.update(a);
	}
